...
public class Controller {
	 ...
	 *
	 */
	public static String getFeatures(String tableName, String geometryColumn, String whereClause)throws SQLException, IOException{
		return JSonUtils.featureTable2GeoJson(tableName,geometryColumn,whereClause,tableName,"4736");		
	}
	
	public static String getGroupBy(String tableName, String whereClause,String column)throws SQLException, IOException{
		return JSonUtils.featureTable2GeoJsonGroupBy(tableName,whereClause,column,"4736");		
	}
	
	public static String countData(String tableName, String val, String whereClause)throws SQLException, IOException{
		return JSonUtils.featureTable2GeoJsonCountData(tableName, val,whereClause,"4736");		
	}
