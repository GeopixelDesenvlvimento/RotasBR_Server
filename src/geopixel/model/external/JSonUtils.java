 ...
 */
	public static String featureTable2GeoJson(String tableName,String geoColumn,String whereClause,String name, String crs) throws SQLException, IOException {
		...
		for(int i =  1; i<= ncolumns; i++){
			if ((md.getColumnName(i)).equals(geoColumn) ){
				sql  += "ST_AsGeoJSON(" + geoColumn + ")::json As geometry"	;
				geometryColumn = i;
			} else {
	...
	public static String featureTable2GeoJsonGroupBy(String tableName,String whereClause,String column, String crs) throws SQLException, IOException {
		String sql = "select * from "+ tableName + " limit 1";
		ResultSet rs = DataBaseService.buildSelect(sql, DataBaseService.getPostgresParameters());
		if (rs == null){
			return "{\"return\":\""+sql+"\"}";
	...
	public static String featureTable2GeoJsonCountData(String tableName,String val, String whereClause, String crs) throws SQLException, IOException {
		// Create a select
